...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_161_giveAchievement,"MainMenuState","giveAchievement",0x39ddd809,"MainMenuState.giveAchievement","MainMenuState.hx",161,0x0e5db805)
...
HXLINE( 168)		this->selectedSomethin = false;
...
HXLINE(  52)		::WeekData_obj::loadTheFirstEnabledMod();
HXLINE(  56)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
HXLINE(  58)		this->debugKeys = ::ClientPrefs_obj::copyKey(( (::Array< int >)(::ClientPrefs_obj::keyBinds->get(HX_("debug_1",05,20,57,5b))) ));
HXLINE(  60)		this->camGame =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
HXLINE(  61)		this->camAchievement =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
HXLINE(  62)		{
HXLINE(  62)			 ::flixel::FlxCamera _hx_tmp = this->camAchievement;
HXDLIN(  62)			_hx_tmp->bgColor = (_hx_tmp->bgColor & 16777215);
HXDLIN(  62)			 ::flixel::FlxCamera _hx_tmp1 = this->camAchievement;
HXDLIN(  62)			_hx_tmp1->bgColor = (_hx_tmp1->bgColor | 0);
            		}
HXLINE(  64)		::flixel::FlxG_obj::cameras->reset(this->camGame);
HXLINE(  65)		::flixel::FlxG_obj::cameras->add(this->camAchievement,null()).StaticCast<  ::flixel::FlxCamera >();
HXLINE(  66)		::flixel::FlxCamera_obj::_defaultCameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,this->camGame);
...
HXLINE(  73)		Float yScroll = ::Math_obj::max((((Float)0.25) - (((Float)0.05) * ( (Float)((this->optionShit->length - 4)) ))),((Float)0.1));
HXLINE(  74)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  74)		::String library = null();
HXDLIN(  74)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuBG",24,65,6d,05),library);
HXDLIN(  74)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  75)		bg1->scrollFactor->set(0,yScroll);
HXLINE(  76)		bg1->setGraphicSize(::Std_obj::_hx_int((bg1->get_width() * ((Float)1.175))),null());
HXLINE(  77)		bg1->updateHitbox();
HXLINE(  78)		bg1->screenCenter(null());
HXLINE(  79)		bg1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  80)		this->add(bg1);
HXLINE(  82)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  83)		this->camFollowPos =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  84)		this->add(this->camFollow);
HXLINE(  85)		this->add(this->camFollowPos);
HXLINE(  87)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  87)		::String library1 = null();
HXDLIN(  87)		 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("menuDesat",26,91,04,72),library1);
HXDLIN(  87)		this->magenta = _hx_tmp2->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE(  88)		this->magenta->scrollFactor->set(0,yScroll);
HXLINE(  89)		 ::flixel::FlxSprite _hx_tmp3 = this->magenta;
HXDLIN(  89)		_hx_tmp3->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  90)		this->magenta->updateHitbox();
HXLINE(  91)		this->magenta->screenCenter(null());
HXLINE(  92)		this->magenta->set_visible(false);
HXLINE(  93)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  94)		this->magenta->set_color(-167525);
HXLINE(  95)		this->add(this->magenta);
HXLINE(  99)		this->menuItems =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 100)		this->add(this->menuItems);
HXLINE( 102)		Float scale = ( (Float)(1) );
HXLINE( 107)		{
HXLINE( 107)			int _g = 0;
HXDLIN( 107)			int _g1 = this->optionShit->length;
HXDLIN( 107)			while((_g < _g1)){
HXLINE( 107)				_g = (_g + 1);
HXDLIN( 107)				int i = (_g - 1);
HXLINE( 109)				Float offset = (( (Float)(108) ) - ((::Math_obj::max(( (Float)(this->optionShit->length) ),( (Float)(4) )) - ( (Float)(4) )) * ( (Float)(80) )));
HXLINE( 110)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,((i * 140) + offset),null());
HXLINE( 111)				menuItem->scale->set_x(scale);
HXLINE( 112)				menuItem->scale->set_y(scale);
HXLINE( 113)				::String key = (HX_("mainmenu/menu_",a9,7b,4b,27) + this->optionShit->__get(i));
HXDLIN( 113)				::String library = null();
HXDLIN( 113)				 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(key,null());
HXDLIN( 113)				bool xmlExists = false;
HXDLIN( 113)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 113)					xmlExists = true;
            				}
HXDLIN( 113)				 ::Dynamic _hx_tmp;
HXDLIN( 113)				if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 113)					_hx_tmp = imageLoaded;
            				}
            				else {
HXLINE( 113)					 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(key,library);
HXDLIN( 113)					_hx_tmp = returnAsset;
            				}
HXDLIN( 113)				::String _hx_tmp1;
HXDLIN( 113)				if (xmlExists) {
HXLINE( 113)					_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE( 113)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            				}
HXDLIN( 113)				menuItem->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 114)				menuItem->animation->addByPrefix(HX_("idle",14,a7,b3,45),(this->optionShit->__get(i) + HX_(" basic",8e,b6,25,79)),24,null(),null(),null());
HXLINE( 115)				menuItem->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),(this->optionShit->__get(i) + HX_(" white",89,d6,28,95)),24,null(),null(),null());
HXLINE( 116)				menuItem->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 117)				menuItem->ID = i;
HXLINE( 118)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 119)				this->menuItems->add(menuItem).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE( 130)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 44),0,(HX_("Psych Engine v",5d,a0,37,c7) + ::MainMenuState_obj::psychEngineVersion),12,null());
...
HXLINE( 134)		int versionShit1 = (::flixel::FlxG_obj::height - 24);
HXDLIN( 134)		 ::flixel::text::FlxText versionShit2 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,versionShit1,0,(HX_("Friday Night Funkin' v",03,65,b0,2f) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c))),12,null());
HXLINE( 135)		versionShit2->scrollFactor->set(null(),null());
HXLINE( 136)		versionShit2->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 137)		this->add(versionShit2);
HXLINE( 141)		this->changeItem(null());
HXLINE( 144)		::Achievements_obj::loadAchievements();
HXLINE( 145)		 ::Date leDate = ::Date_obj::now();
HXLINE( 146)		bool _hx_tmp4;
HXDLIN( 146)		if ((leDate->getDay() == 5)) {
HXLINE( 146)			_hx_tmp4 = (leDate->getHours() >= 18);
            		}
            		else {
HXLINE( 146)			_hx_tmp4 = false;
            		}
HXDLIN( 146)		if (_hx_tmp4) {
HXLINE( 147)			int achieveID = ::Achievements_obj::getAchievementIndex(HX_("friday_night_play",9b,1f,4e,c7));
HXLINE( 148)			if (!(::Achievements_obj::isAchievementUnlocked(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) )))) {
HXLINE( 149)				::Achievements_obj::achievementsMap->set(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) ),true);
HXLINE( 150)				this->giveAchievement();
HXLINE( 151)				::ClientPrefs_obj::saveSettings();
            			}
            		}
...
void MainMenuState_obj::giveAchievement(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_161_giveAchievement)
HXLINE( 162)		this->add( ::AchievementObject_obj::__alloc( HX_CTX ,HX_("friday_night_play",9b,1f,4e,c7),this->camAchievement));
HXLINE( 163)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 163)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
HXLINE( 164)		::haxe::Log_obj::trace(HX_("Giving achievement \"friday_night_play\"",e6,1b,7d,1f),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),164,HX_("MainMenuState",59,88,5e,20),HX_("giveAchievement",1e,ea,83,24)));
            	}
...
HXLINE( 267)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_171_update)
HXDLIN( 171)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 172)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 174)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 174)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 177)		Float lerpVal = ::Math_obj::max(( (Float)(0) ),::Math_obj::min(( (Float)(1) ),(elapsed * ((Float)7.5))));
HXLINE( 178)		Float a = this->camFollowPos->x;
HXDLIN( 178)		Float a1 = this->camFollowPos->y;
HXDLIN( 178)		this->camFollowPos->setPosition((a + (lerpVal * (this->camFollow->x - a))),(a1 + (lerpVal * (this->camFollow->y - a1))));
HXLINE( 180)		if (!(this->selectedSomethin)) {
...
HXLINE( 188)			if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
...
HXLINE( 196)				this->selectedSomethin = true;
HXLINE( 197)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 197)				_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 198)				::MusicBeatState_obj::switchState( ::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            			}
HXLINE( 201)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 203)				if ((this->optionShit->__get(::MainMenuState_obj::curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 205)					::CoolUtil_obj::browserLoad(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
...
HXLINE( 216)						if ((::MainMenuState_obj::curSelected != spr->ID)) {
...
HXLINE( 230)								::String daChoice = _gthis->optionShit->__get(::MainMenuState_obj::curSelected);
HXLINE( 232)								::String _hx_switch_0 = daChoice;
            								if (  (_hx_switch_0==HX_("awards",b6,92,c1,8d)) ){
HXLINE( 243)									::MusicBeatState_obj::switchState( ::AchievementsMenuState_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 237)									::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 237)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("mods",71,d3,60,48)) ){
HXLINE( 240)									::MusicBeatState_obj::switchState( ::ModsMenuState_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 235)									::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 228)							::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 209)					this->selectedSomethin = true;
HXLINE( 210)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 210)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 212)					if (::ClientPrefs_obj::flashing) {
HXLINE( 212)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 214)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 255)				if (::flixel::FlxG_obj::keys->checkKeyArrayState(this->debugKeys,2)) {
HXLINE( 257)					this->selectedSomethin = true;
HXLINE( 258)					::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
            				}
            			}
            		}
HXLINE( 263)		this->super::update(elapsed);
HXLINE( 265)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
HXLINE( 282)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 283)			spr->updateHitbox();
HXLINE( 285)			if ((spr->ID == ::MainMenuState_obj::curSelected)) {
HXLINE( 287)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 288)				Float add = ( (Float)(0) );
HXLINE( 289)				if ((_gthis->menuItems->length > 4)) {
HXLINE( 290)					add = ( (Float)((_gthis->menuItems->length * 8)) );
            				}
HXLINE( 292)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 292)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 292)				_gthis1->setPosition(_hx_tmp,(spr->getGraphicMidpoint(null())->y - add));
...
HXDLIN( 272)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 273)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::MainMenuState >();
HXDLIN( 273)		::MainMenuState_obj::curSelected = (::MainMenuState_obj::curSelected + huh);
HXLINE( 275)		if ((::MainMenuState_obj::curSelected >= this->menuItems->length)) {
HXLINE( 276)			::MainMenuState_obj::curSelected = 0;
            		}
HXLINE( 277)		if ((::MainMenuState_obj::curSelected < 0)) {
HXLINE( 278)			::MainMenuState_obj::curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 280)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
HXDLIN(  28)		psychEngineVersion = HX_("0.5.2h",8d,63,bb,d0);
            	}
{
