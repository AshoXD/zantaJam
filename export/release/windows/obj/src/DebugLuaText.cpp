...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2078_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",2078,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2090_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",2090,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2078_new)
HXLINE(2080)		this->disableTime = ((Float)6);
HXLINE(2083)		this->parentGroup = parentGroup;
HXLINE(2084)		super::__construct(10,10,0,text,16,null());
HXLINE(2085)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(2085)		::String _hx_tmp;
HXDLIN(2085)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(2085)			_hx_tmp = file;
            		}
            		else {
HXLINE(2085)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(2085)		this->setFormat(_hx_tmp,20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2086)		this->scrollFactor->set(null(),null());
HXLINE(2087)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2090_update)
HXLINE(2091)		this->super::update(elapsed);
HXLINE(2092)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2092)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(2093)		if ((this->disableTime <= 0)) {
HXLINE(2094)			this->kill();
HXLINE(2095)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(2096)			this->destroy();
            		}
            		else {
HXLINE(2098)			if ((this->disableTime < 1)) {
HXLINE(2098)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
