...
::__ASSET__assets_fonts_renogare_ttf_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_renogare_ttf_obj::__register();
...
::__ASSET__assets_fonts_renogare_ttf_obj::__boot();
