...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_125_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",125,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_148_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",148,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_157_coolStartDeath,"GameOverSubstate","coolStartDeath",0x265fa8f2,"GameOverSubstate.coolStartDeath","GameOverSubstate.hx",157,0x01fbc1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_170_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",170,0x01fbc1e7)
...
HXLINE( 153)		this->isEnding = false;
...
HXLINE(  40)		::PlayState_obj::instance->callOnLuas(HX_("onGameOverStart",7d,47,34,c7),::cpp::VirtualArray_obj::__new(0));
...
HXLINE(  79)		::PlayState_obj::instance->callOnLuas(HX_("onUpdate",88,7c,b2,66),::cpp::VirtualArray_obj::__new(1)->init(0,elapsed));
...
HXLINE(  97)				::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
            			}
            			else {
HXLINE(  99)				::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
            			}
HXLINE( 101)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 101)			::String library = null();
HXDLIN( 101)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 101)			_hx_tmp->playMusic(file,null(),null(),null());
HXLINE( 102)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,false));
            		}
HXLINE( 105)		if ((this->boyfriend->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE( 107)			bool _hx_tmp;
HXDLIN( 107)			if ((this->boyfriend->animation->_curAnim->curFrame >= 12)) {
HXLINE( 107)				_hx_tmp = !(this->isFollowingAlready);
            			}
            			else {
HXLINE( 107)				_hx_tmp = false;
            			}
HXDLIN( 107)			if (_hx_tmp) {
HXLINE( 109)				::flixel::FlxG_obj::camera->follow(this->camFollowPos,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),1);
HXLINE( 110)				this->updateCamera = true;
HXLINE( 111)				this->isFollowingAlready = true;
            			}
HXLINE( 114)			bool _hx_tmp1;
HXDLIN( 114)			if (this->boyfriend->animation->_curAnim->finished) {
HXLINE( 114)				_hx_tmp1 = !(this->playingDeathSound);
            			}
            			else {
HXLINE( 114)				_hx_tmp1 = false;
            			}
HXDLIN( 114)			if (_hx_tmp1) {
HXLINE( 116)				if (::hx::IsEq( ::PlayState_obj::SONG->__Field(HX_("stage",be,6a,0b,84),::hx::paccDynamic),HX_("tank",ea,ba,f6,4c) )) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::GameOverSubstate,_gthis) HXARGC(0)
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_125_update)
HXLINE( 125)						if (!(_gthis->isEnding)) {
HXLINE( 127)							 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 127)							 ::Dynamic onComplete = null();
HXDLIN( 127)							if (::hx::IsNull( _this->_channel )) {
HXLINE( 127)								_this->play(null(),null(),null());
            							}
HXDLIN( 127)							if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 127)								_this->fadeTween->cancel();
            							}
HXDLIN( 127)							_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(1) ),( (Float)(4) ),((Float)0.2), ::Dynamic(::hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            						}
            					}
            					HX_END_LOCAL_FUNC0((void))

HXLINE( 118)					this->playingDeathSound = true;
HXLINE( 119)					this->coolStartDeath(((Float)0.2));
HXLINE( 121)					::Array< int > exclude = ::Array_obj< int >::__new(0);
HXLINE( 124)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 124)					_hx_tmp->play(::Paths_obj::sound((HX_("jeffGameover/jeffGameover-",3e,03,48,86) + ::flixel::FlxG_obj::random->_hx_int(1,25,exclude)),null()),1,false,null(),true, ::Dynamic(new _hx_Closure_0(_gthis)));
            				}
            				else {
HXLINE( 133)					this->coolStartDeath(null());
            				}
HXLINE( 135)				this->boyfriend->startedDeath = true;
            			}
            		}
HXLINE( 139)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 141)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
HXLINE( 143)		::PlayState_obj::instance->callOnLuas(HX_("onUpdatePost",08,11,55,db),::cpp::VirtualArray_obj::__new(1)->init(0,elapsed));
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_148_beatHit)
HXDLIN( 148)		this->super::beatHit();
            	}
...
void GameOverSubstate_obj::coolStartDeath( ::Dynamic __o_volume){
            	...
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_157_coolStartDeath)
HXDLIN( 157)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 157)		::String library = null();
HXDLIN( 157)		 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::GameOverSubstate_obj::loopSoundName,library);
HXDLIN( 157)		_hx_tmp->playMusic(file,volume,null(),null());
            	}
...
HXDLIN( 162)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_172_endBullshit)
HXLINE( 172)					::MusicBeatState_obj::resetState();
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_170_endBullshit)
HXLINE( 170)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 164)			this->isEnding = true;
HXLINE( 165)			this->boyfriend->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 166)			{
...
HXDLIN( 167)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::GameOverSubstate_obj::endSoundName,library);
HXDLIN( 167)			_hx_tmp->play(file,null(),null(),null(),null(),null());
HXLINE( 168)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
HXLINE( 175)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,true));
            		}
            	}
