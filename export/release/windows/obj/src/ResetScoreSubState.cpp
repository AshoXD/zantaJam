...
HXLINE(  42)		 ::Alphabet text =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(180) ),HX_("Reset the score of",c5,93,fa,2d),true,null(),null(),null(),null());
...
HXLINE(  47)		 ::Alphabet text1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text->y + 90),name,true,false,((Float)0.05),tooLong,null());
...
HXLINE(  62)		this->yesText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text1->y + 150),HX_("Yes",07,e1,43,00),true,null(),null(),null(),null());
...
HXLINE(  66)		this->noText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text1->y + 150),HX_("No",61,44,00,00),true,null(),null(),null(),null());
