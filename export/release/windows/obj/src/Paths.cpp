...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_362_returnSound,"Paths","returnSound",0xb166e49f,"Paths.returnSound","Paths.hx",362,0x309ea470)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_449_getModDirectories,"Paths","getModDirectories",0x27c7a23f,"Paths.getModDirectories","Paths.hx",449,0x309ea470)
...
static const ::String _hx_array_data_50847b0e_47[] = {
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_361_boot,"Paths","boot",0x8ce6e592,"Paths.boot","Paths.hx",361,0x309ea470)
...
HXLINE( 338)				newGraphic->persist = true;
HXLINE( 339)				::Paths_obj::currentTrackedAssets->set(modKey,newGraphic);
            			}
HXLINE( 341)			::Paths_obj::localTrackedAssets->push(modKey);
HXLINE( 342)			return ( ( ::flixel::graphics::FlxGraphic)(::Paths_obj::currentTrackedAssets->get(modKey)) );
            		}
HXLINE( 346)		::String path = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXLINE( 348)		if (::openfl::utils::Assets_obj::exists(path,HX_("IMAGE",3b,57,57,3b))) {
HXLINE( 349)			if (!(::Paths_obj::currentTrackedAssets->exists(path))) {
HXLINE( 350)				 ::flixel::graphics::FlxGraphic newGraphic = ::flixel::FlxG_obj::bitmap->add(path,false,path);
HXLINE( 351)				newGraphic->persist = true;
HXLINE( 352)				::Paths_obj::currentTrackedAssets->set(path,newGraphic);
            			}
HXLINE( 354)			::Paths_obj::localTrackedAssets->push(path);
HXLINE( 355)			return ( ( ::flixel::graphics::FlxGraphic)(::Paths_obj::currentTrackedAssets->get(path)) );
            		}
HXLINE( 357)		::haxe::Log_obj::trace(HX_("oh no its returning null NOOOO",93,c9,d3,00),::hx::SourceInfo(HX_("source/Paths.hx",64,c7,bd,1c),357,HX_("Paths",0e,7b,84,50),HX_("returnGraphic",d8,d3,95,0b)));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,returnGraphic,return )
 ...
 ::openfl::media::Sound Paths_obj::returnSound(::String path,::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_362_returnSound)
HXLINE( 364)		::String file = ::Paths_obj::modFolders(((((path + HX_("/",2f,00,00,00)) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXLINE( 365)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 366)			if (!(::Paths_obj::currentTrackedSounds->exists(file))) {
HXLINE( 367)				::Dynamic this1 = ::Paths_obj::currentTrackedSounds;
HXDLIN( 367)				( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            			}
HXLINE( 369)			::Paths_obj::localTrackedAssets->push(key);
HXLINE( 370)			return ( ( ::openfl::media::Sound)(::Paths_obj::currentTrackedSounds->get(file)) );
            		}
HXLINE( 374)		::String gottenPath = ::Paths_obj::getPath((((((HX_("",00,00,00,00) + path) + HX_("/",2f,00,00,00)) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("SOUND",af,c4,ba,fe),library);
HXLINE( 375)		int gottenPath1 = (gottenPath.indexOf(HX_(":",3a,00,00,00),null()) + 1);
HXDLIN( 375)		gottenPath = gottenPath.substring(gottenPath1,gottenPath.length);
HXLINE( 377)		if (!(::Paths_obj::currentTrackedSounds->exists(gottenPath))) {
HXLINE( 379)			::Dynamic this1 = ::Paths_obj::currentTrackedSounds;
HXDLIN( 379)			( ( ::haxe::ds::StringMap)(this1) )->set(gottenPath,::openfl::media::Sound_obj::fromFile((HX_("./",41,28,00,00) + gottenPath)));
            		}
...
HXLINE( 447)		return (HX_("mods/",9e,2f,58,0c) + key);
            	}
...
::Array< ::String > Paths_obj::getModDirectories(){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_449_getModDirectories)
HXLINE( 450)		::Array< ::String > list = ::Array_obj< ::String >::__new(0);
HXLINE( 451)		::String modsFolder = HX_("mods/",9e,2f,58,0c);
HXLINE( 452)		if (::sys::FileSystem_obj::exists(modsFolder)) {
HXLINE( 453)			int _g = 0;
HXDLIN( 453)			::Array< ::String > _g1 = ::sys::FileSystem_obj::readDirectory(modsFolder);
HXDLIN( 453)			while((_g < _g1->length)){
HXLINE( 453)				::String folder = _g1->__get(_g);
HXDLIN( 453)				_g = (_g + 1);
HXLINE( 454)				::String path = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,modsFolder)->init(1,folder));
HXLINE( 455)				bool _hx_tmp;
HXDLIN( 455)				bool _hx_tmp1;
HXDLIN( 455)				if (::sys::FileSystem_obj::isDirectory(path)) {
HXLINE( 455)					_hx_tmp1 = !(::Paths_obj::ignoreModFolders->contains(folder));
            				}
            				else {
HXLINE( 455)					_hx_tmp1 = false;
            				}
HXDLIN( 455)				if (_hx_tmp1) {
HXLINE( 455)					_hx_tmp = !(list->contains(folder));
            				}
            				else {
HXLINE( 455)					_hx_tmp = false;
            				}
HXDLIN( 455)				if (_hx_tmp) {
HXLINE( 456)					list->push(folder);
            				}
            			}
            		}
HXLINE( 460)		return list;
            	}
...
HXDLIN(  33)		ignoreModFolders = ::Array_obj< ::String >::fromData( _hx_array_data_50847b0e_47,15);
            	}
{
...
{
            	HX_GC_STACKFRAME(&_hx_pos_d75e02b628d1544a_361_boot)
HXDLIN( 361)		currentTrackedSounds =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
