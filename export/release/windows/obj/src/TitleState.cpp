...
HXLINE( 284)		if (::hx::IsNull( easterEgg )) {
HXLINE( 284)			easterEgg = HX_("",00,00,00,00);
            		}
HXLINE( 286)		{
HXLINE( 286)			::String _g = easterEgg.toUpperCase();
HXLINE( 307)			{
HXLINE( 311)				 ::flixel::FlxSprite _hx_tmp5 = this->gfDance;
HXDLIN( 311)				::String library1 = null();
HXDLIN( 311)				 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::returnGraphic(HX_("gfDanceTitle",64,64,d2,7b),null());
HXDLIN( 311)				bool xmlExists1 = false;
...
HXLINE( 311)					xmlExists1 = true;
            				}
HXDLIN( 311)				 ::Dynamic _hx_tmp6;
HXDLIN( 311)				if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE( 311)					_hx_tmp6 = imageLoaded1;
            				}
            				else {
HXLINE( 311)					 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("gfDanceTitle",64,64,d2,7b),library1);
HXDLIN( 311)					_hx_tmp6 = returnAsset;
            				}
HXDLIN( 311)				::String _hx_tmp7;
HXDLIN( 311)				if (xmlExists1) {
HXLINE( 311)					_hx_tmp7 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE( 311)					_hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            				}
HXDLIN( 311)				_hx_tmp5->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,_hx_tmp7));
HXLINE( 312)				this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 313)				this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_7,15),HX_("",00,00,00,00),24,false,null(),null());
            			}
            		}
HXLINE( 315)		this->gfDance->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 317)		this->add(this->gfDance);
...
HXLINE( 334)		 ::flixel::FlxSprite _hx_tmp8 = this->titleText;
HXDLIN( 334)		 ::openfl::display::BitmapData _hx_tmp9 = ::openfl::display::BitmapData_obj::fromFile(path);
HXDLIN( 334)		_hx_tmp8->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp9,::sys::io::File_obj::getContent(::StringTools_obj::replace(path,HX_(".png",3b,2d,bd,1e),HX_(".xml",69,3e,c3,1e)))));
...
HXDLIN( 347)		::String library2 = null();
HXDLIN( 347)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("logo",6b,9f,b7,47),library2);
...
HXLINE( 362)		this->credTextShit =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("",00,00,00,00),true,null(),null(),null(),null());
HXLINE( 363)		this->credTextShit->screenCenter(null());
HXLINE( 367)		this->credTextShit->set_visible(false);
HXLINE( 369)		 ::flixel::FlxSprite _hx_tmp10 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
HXDLIN( 369)		::String library3 = null();
HXDLIN( 369)		 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("newgrounds_logo",1e,5c,8d,a6),library3);
HXDLIN( 369)		this->ngSpr = _hx_tmp10->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE( 370)		this->add(this->ngSpr);
HXLINE( 371)		this->ngSpr->set_visible(false);
HXLINE( 372)		 ::flixel::FlxSprite _hx_tmp11 = this->ngSpr;
HXDLIN( 372)		_hx_tmp11->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
...
HXLINE( 527)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false,null(),null(),null());
...
HXLINE( 540)			 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false,null(),null(),null());
...
HXLINE( 576)			switch((int)(this->sickBeats)){
            				case (int)1: {
HXLINE( 580)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_18,1),15);
            				}
            				break;
            				case (int)3: {
...
HXLINE( 596)					this->deleteCoolText();
            				...
            				break;
            				case (int)5: {
HXLINE( 602)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_19,2),-40);
            				}
            				break;
            				case (int)7: {
