...
HX_LOCAL_STACK_FRAME(_hx_pos_c4fc54429970e34b_78_update,"AchievementsMenuState","update",0x4b1d5069,"AchievementsMenuState.update","AchievementsMenuState.hx",78,0x310b7570)
HX_LOCAL_STACK_FRAME(_hx_pos_c4fc54429970e34b_94_changeSelection,"AchievementsMenuState","changeSelection",0xa841825c,"AchievementsMenuState.changeSelection","AchievementsMenuState.hx",94,0x310b7570)
...
HXDLIN(  55)				 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((100 * i) + 210)) ),optionText,false,false,null(),null(),null());
HXLINE(  56)				optionText1->isMenuItem = true;
HXLINE(  57)				optionText1->set_x((optionText1->x + 280));
HXLINE(  58)				optionText1->xAdd = ( (Float)(200) );
HXLINE(  59)				optionText1->targetY = ( (Float)(i) );
HXLINE(  60)				this->grpOptions->add(optionText1).StaticCast<  ::Alphabet >();
HXLINE(  62)				 ::AttachedAchievement icon =  ::AttachedAchievement_obj::__alloc( HX_CTX ,(optionText1->x - ( (Float)(105) )),optionText1->y,achieveName);
HXLINE(  63)				icon->sprTracker = optionText1;
HXLINE(  64)				this->achievementArray->push(icon);
HXLINE(  65)				this->add(icon);
            			}
            		}
HXLINE(  68)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,150,600,980,HX_("",00,00,00,00),32,null());
HXLINE(  69)		 ::flixel::text::FlxText _hx_tmp = this->descText;
...
HXDLIN(  69)		_hx_tmp->setFormat(_hx_tmp1,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  70)		this->descText->scrollFactor->set(null(),null());
HXLINE(  71)		this->descText->set_borderSize(((Float)2.4));
HXLINE(  72)		this->add(this->descText);
...
void AchievementsMenuState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_c4fc54429970e34b_78_update)
...
void AchievementsMenuState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_c4fc54429970e34b_94_changeSelection)
HXLINE(  95)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::AchievementsMenuState >();
HXDLIN(  95)		::AchievementsMenuState_obj::curSelected = (::AchievementsMenuState_obj::curSelected + change);
HXLINE(  96)		if ((::AchievementsMenuState_obj::curSelected < 0)) {
HXLINE(  97)			::AchievementsMenuState_obj::curSelected = (this->options->length - 1);
            		}
HXLINE(  98)		if ((::AchievementsMenuState_obj::curSelected >= this->options->length)) {
HXLINE(  99)			::AchievementsMenuState_obj::curSelected = 0;
            		}
HXLINE( 101)		int bullShit = 0;
HXLINE( 103)		{
HXLINE( 103)			int _g = 0;
HXDLIN( 103)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 103)			while((_g < _g1->length)){
HXLINE( 103)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 103)				_g = (_g + 1);
HXLINE( 104)				item->targetY = ( (Float)((bullShit - ::AchievementsMenuState_obj::curSelected)) );
HXLINE( 105)				bullShit = (bullShit + 1);
HXLINE( 107)				item->set_alpha(((Float)0.6));
HXLINE( 108)				if ((item->targetY == 0)) {
HXLINE( 109)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 113)		{
HXLINE( 113)			int _g2 = 0;
HXDLIN( 113)			int _g3 = this->achievementArray->length;
HXDLIN( 113)			while((_g2 < _g3)){
HXLINE( 113)				_g2 = (_g2 + 1);
HXDLIN( 113)				int i = (_g2 - 1);
HXLINE( 114)				this->achievementArray->__get(i).StaticCast<  ::AttachedAchievement >()->set_alpha(((Float)0.6));
HXLINE( 115)				if ((i == ::AchievementsMenuState_obj::curSelected)) {
HXLINE( 116)					this->achievementArray->__get(i).StaticCast<  ::AttachedAchievement >()->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 119)		this->descText->set_text(( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(::AchievementsMenuState_obj::curSelected))->__GetItem(1)) ));
HXLINE( 120)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 120)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
            	}
