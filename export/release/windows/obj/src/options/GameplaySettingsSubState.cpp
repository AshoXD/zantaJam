...
HX_LOCAL_STACK_FRAME(_hx_pos_37066bb048b40dd4_146_onChangeHitsoundVolume,"options.GameplaySettingsSubState","onChangeHitsoundVolume",0x34624629,"options.GameplaySettingsSubState.onChangeHitsoundVolume","options/GameplaySettingsSubState.hx",146,0x85e60df3)
namespace options{
...
HXLINE(  84)		option5->onChange = this->onChangeHitsoundVolume_dyn();
HXLINE(  86)		 ::options::Option option6 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Rating Offset",36,6d,0e,f3),HX_("Changes how late/early you have to hit for a \"Sick!\"\nHigher values mean you have to hit later.",98,66,84,c8),HX_("ratingOffset",90,b3,eb,a5),HX_("int",ef,0c,50,00),0,null());
HXLINE(  91)		option6->displayFormat = HX_("%vms",57,ce,ce,18);
HXLINE(  92)		option6->scrollSpeed = ( (Float)(20) );
HXLINE(  93)		option6->minValue = -30;
HXLINE(  94)		option6->maxValue = 30;
HXLINE(  95)		this->addOption(option6);
HXLINE(  97)		 ::options::Option option7 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Sick! Hit Window",da,75,69,f4),HX_("Changes the amount of time you have\nfor hitting a \"Sick!\" in milliseconds.",70,a1,b8,aa),HX_("sickWindow",4e,b7,93,ed),HX_("int",ef,0c,50,00),45,null());
HXLINE( 102)		option7->displayFormat = HX_("%vms",57,ce,ce,18);
HXLINE( 103)		option7->scrollSpeed = ( (Float)(15) );
HXLINE( 104)		option7->minValue = 15;
HXLINE( 105)		option7->maxValue = 45;
HXLINE( 106)		this->addOption(option7);
HXLINE( 108)		 ::options::Option option8 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Good Hit Window",40,78,9c,02),HX_("Changes the amount of time you have\nfor hitting a \"Good\" in milliseconds.",6e,11,57,54),HX_("goodWindow",0d,a9,05,67),HX_("int",ef,0c,50,00),90,null());
HXLINE( 113)		option8->displayFormat = HX_("%vms",57,ce,ce,18);
HXLINE( 114)		option8->scrollSpeed = ( (Float)(30) );
HXLINE( 115)		option8->minValue = 15;
HXLINE( 116)		option8->maxValue = 90;
HXLINE( 117)		this->addOption(option8);
HXLINE( 119)		 ::options::Option option9 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Bad Hit Window",f8,a4,d4,a7),HX_("Changes the amount of time you have\nfor hitting a \"Bad\" in milliseconds.",92,b2,88,fa),HX_("badWindow",95,db,0a,32),HX_("int",ef,0c,50,00),135,null());
HXLINE( 124)		option9->displayFormat = HX_("%vms",57,ce,ce,18);
HXLINE( 125)		option9->scrollSpeed = ( (Float)(60) );
HXLINE( 126)		option9->minValue = 15;
HXLINE( 127)		option9->maxValue = 135;
HXLINE( 128)		this->addOption(option9);
HXLINE( 130)		 ::options::Option option10 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Safe Frames",19,0a,34,55),HX_("Changes how many frames you have for\nhitting a note earlier or late.",09,48,9a,6e),HX_("safeFrames",d3,18,18,62),HX_("float",9c,c5,96,02),10,null());
HXLINE( 135)		option10->scrollSpeed = ( (Float)(5) );
HXLINE( 136)		option10->minValue = 2;
HXLINE( 137)		option10->maxValue = 10;
HXLINE( 138)		option10->changeValue = ((Float)0.1);
...
void GameplaySettingsSubState_obj::onChangeHitsoundVolume(){
            	HX_STACKFRAME(&_hx_pos_37066bb048b40dd4_146_onChangeHitsoundVolume)
HXDLIN( 146)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 146)		 ::openfl::media::Sound _hx_tmp1 = ::Paths_obj::sound(HX_("hitsound",9c,79,fe,2c),null());
HXDLIN( 146)		_hx_tmp->play(_hx_tmp1,::ClientPrefs_obj::hitsoundVolume,null(),null(),null(),null());
            	}
