...
HXLINE(  65)				{
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(0)),true,null(),null(),null(),null());
HXLINE(  67)						optionText->set_x(( (Float)((this->posX + 250)) ));
HXLINE(  68)						this->grpNumbers->add(optionText).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(1)),true,null(),null(),null(),null());
HXLINE(  67)						optionText1->set_x(( (Float)(((this->posX + 225) + 250)) ));
HXLINE(  68)						this->grpNumbers->add(optionText1).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText2 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(2)),true,null(),null(),null(),null());
...
HXLINE(  87)		this->hsbText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("Hue    Saturation  Brightness",7b,47,68,9c),false,false,0,((Float)0.65),null());
