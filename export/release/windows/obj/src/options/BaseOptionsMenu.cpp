...
HXLINE(  78)		 ::Alphabet titleText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->title,true,false,0,((Float)0.6),null());
...
HXLINE(  92)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),this->optionsArray->__get(i).StaticCast<  ::options::Option >()->name,false,false,null(),null(),null());
