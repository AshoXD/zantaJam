...
HXLINE(  46)			int _hx_tmp4 = ::Math_obj::floor((this->get_width() / ( (Float)(3) )));
HXDLIN(  46)			this->loadGraphic(file,true,_hx_tmp4,::Math_obj::floor(this->get_height()),null(),null());
HXLINE(  47)			this->iconOffsets[0] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  48)			this->iconOffsets[1] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  49)			this->iconOffsets[2] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  50)			this->updateHitbox();
HXLINE(  52)			this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_5,3),0,false,this->isPlayer,null());
