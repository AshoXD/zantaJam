...
HXLINE( 205)		this->box =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,((Float)-49.15),540,null());
...
HXLINE( 304)					this->daText =  ::Alphabet_obj::__alloc( HX_CTX ,::DialogueBoxPsych_obj::DEFAULT_TEXT_X,::DialogueBoxPsych_obj::DEFAULT_TEXT_Y,this->textToType,false,true,((Float)0.0),((Float)0.7),HX_("alphabetWhite",f6,54,52,a3));
...
HXLINE( 498)		this->daText =  ::Alphabet_obj::__alloc( HX_CTX ,::DialogueBoxPsych_obj::DEFAULT_TEXT_X,::DialogueBoxPsych_obj::DEFAULT_TEXT_Y,this->textToType,false,true,curDialogue->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic),((Float)0.7),null());
...
Float DialogueBoxPsych_obj::DEFAULT_TEXT_X;

Float DialogueBoxPsych_obj::DEFAULT_TEXT_Y;
...
bool DialogueBoxPsych_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"DEFAULT_TEXT_X") ) { DEFAULT_TEXT_X=ioValue.Cast< Float >(); return true; }
		if (HX_FIELD_EQ(inName,"DEFAULT_TEXT_Y") ) { DEFAULT_TEXT_Y=ioValue.Cast< Float >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo DialogueBoxPsych_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsFloat,(void *) &DialogueBoxPsych_obj::DEFAULT_TEXT_X,HX_("DEFAULT_TEXT_X",24,d8,31,6c)},
	{::hx::fsFloat,(void *) &DialogueBoxPsych_obj::DEFAULT_TEXT_Y,HX_("DEFAULT_TEXT_Y",25,d8,31,6c)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXDLIN( 279)		DEFAULT_TEXT_X = ((Float)23.55);
            	}
{
            	HX_STACKFRAME(&_hx_pos_128129519e640548_280_boot)
HXDLIN( 280)		DEFAULT_TEXT_Y = ((Float)550.6);
            	}
}
