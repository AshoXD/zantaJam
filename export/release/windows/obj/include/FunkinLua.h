...
class HXCPP_CLASS_ATTRIBUTES FunkinLua_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic getPropertyLoopThingWhatever(::Array< ::String > killMe, ::Dynamic checkForTextsToo, ::Dynamic noGameOver);
		static ::Dynamic getPropertyLoopThingWhatever_dyn();

		static  ::Dynamic getObjectDirectly(::String objectName, ::Dynamic checkForTextsToo, ::Dynamic noGameOver);
		static ::Dynamic getObjectDirectly_dyn();

		static  ::flixel::FlxState getInstance();
		static ::Dynamic getInstance_dyn();

		static ::String CLENSE;
