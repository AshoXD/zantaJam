...
class HXCPP_CLASS_ATTRIBUTES AlphaCharacter_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,Float textSize,::String __o_asset);
		...
		static ::hx::ObjectPtr< AlphaCharacter_obj > __new(Float x,Float y,Float textSize,::String __o_asset);
		static ::hx::ObjectPtr< AlphaCharacter_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,Float textSize,::String __o_asset);
