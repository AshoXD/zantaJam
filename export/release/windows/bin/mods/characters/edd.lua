...
function opponentNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Tom Note' then
		triggerEvent('Change Icon', 'dad', 'tom')
		if noteData == 0 then
	...
	if noteType == 'Tord Note' then
		triggerEvent('Change Icon', 'dad', 'tord')
		if noteData == 0 then
	...
	if noteType == 'Matt Note' then
		triggerEvent('Change Icon', 'dad', 'matt')
		if noteData == 0 then
	...
	if noteType == 'Duet Note' then
		triggerEvent('Change Icon', 'dad', 'edd')
		if noteData == 0 then
			objectPlayAnimation('tom', 'singLEFT', true)
			runTimer('tomBack', 1, 1)
			tomIdle = false;
...
function onEvent(tag, var1, var2)
	if tag == 'Edd Play Anim' then
		...
		if var1 == 'tord' then
			tordIdle = false;
			cancelTimer('tordBack')
		end
		if var1 == 'matt' then
			mattIdle = false;
			cancelTimer('mattBack')
		end
		if var1 == 'tom' then
			tomIdle = false;
			cancelTimer('tomBack')
